...
public class BluetoothLeService extends Service {
    ...
    public int mConnectionStrength = 0;
    ...
    public final static String ACTION_GATT_CONNECTED = "com.hybridplay.bluetooth.le.ACTION_GATT_CONNECTED";
    public final static String ACTION_GATT_DISCONNECTED = "com.hybridplay.bluetooth.le.ACTION_GATT_DISCONNECTED";
    public final static String ACTION_GATT_SERVICES_DISCOVERED = "com.hybridplay.bluetooth.le.ACTION_GATT_SERVICES_DISCOVERED";
    public final static String ACTION_DATA_AVAILABLE = "com.hybridplay.bluetooth.le.ACTION_DATA_AVAILABLE";
    public final static String EXTRA_DATA = "com.hybridplay.bluetooth.le.EXTRA_DATA";
    public final static String EXTRA_DATA_BYTE = "com.hybridplay.bluetooth.le.EXTRA_DATA_BYTE";
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
            ...
            if (newState == BluetoothProfile.STATE_CONNECTED) {
                ...
                // retrieve BLUETOOTH Signal Strength
